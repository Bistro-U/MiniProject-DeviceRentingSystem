        ...
        <div class="row justify-content-center align-items-center login-wapper d-flex">
            <div class="col-sm-3 login-form">
                ...
                <form>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12 d-flex justify-content-center">
                            <a class="btn btn-lg btn-google btn-block text-uppercase btn-outline" href="https://accounts.google.com/o/oauth2/auth?scope=email profile&redirect_uri=http://localhost:8080/DeviceManagement/LoginHandler&response_type=code
