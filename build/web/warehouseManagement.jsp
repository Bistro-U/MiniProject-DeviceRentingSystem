                ...
                <table class="table text-center">
                    ...
                    <tbody>
                        ...
                        <form method="POST" action="MainController">
                            ...
                            <td><button type="submit" name="action" value="UpdateWarehouse" class="btn btn-dark">Update</button></td> 
                            <td><button type="submit" name="action" value="DeleteWarehouse" onclick="return confirmDelete()" class="btn btn-dark">Delete</button></td>
                        </form>
                        </tr>
                    </c:forEach>
                    </tbody>
