...
public class BrandDAO {
    ...
    private static final String GET_LIST_BRAND = "SELECT brandID, brandName, cateID, status FROM brand WHERE cateID=?";
    ...
    public Map<Integer, String> getListBrand(String cateID) throws SQLException {
